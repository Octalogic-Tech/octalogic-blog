...
export type Post = Node &
  Document & {
    ...
    isHeroPost?: Maybe<Scalars["Boolean"]>;
...
export type PostFilter = {
  ...
  isHeroPost?: InputMaybe<BooleanFilter>;
  categories?: InputMaybe<StringFilter>;
  postDate?: InputMaybe<DatetimeFilter>;
...
export type PostMutation = {
  ...
  isHeroPost?: InputMaybe<Scalars["Boolean"]>;
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    post(
      ...
      options?: C,
    ): Promise<{ data: PostQuery; variables: PostQueryVariables; query: string }> {
      return requester<
    ...
    postConnection(
      ...
      return requester<
        { data: PostConnectionQuery; variables: PostConnectionQueryVariables; query: string },
...
const generateRequester = (client: TinaClient) => {
  const requester: (doc: any, vars?: any, options?: any, client) => Promise<any> = async (
    doc,
    vars,
    _options,
  ) => {
...
export const ExperimentalGetTinaClient = () =>
  getSdk(generateRequester(createClient({ url: "http://localhost:4001/graphql", queries })));
